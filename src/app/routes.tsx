...
function Root() {
  return (
    <div className="min-h-screen bg-background text-foreground transition-colors duration-300 relative">
      ...
      <motion.a
        href="https://wa.me/94779780053?text=Can%20I%20get%20more%20info%3F"
        target="_blank"
        ...
        whileTap={{ scale: 0.95 }}
        className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#20ba5a] text-white rounded-full shadow-[0_4px_20px_rgba(37,211,102,0.4)] hover:shadow-[0_6px_24px_rgba(37,211,102,0.6)] transition-all duration-300 cursor-pointer group"
