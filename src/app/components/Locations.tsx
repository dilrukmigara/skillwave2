      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {locations.map((location, index) => (
            ...
            >
              <Card className="h-full hover:shadow-2xl transition-all duration-300 border-0 dark:border dark:border-white/5 overflow-hidden group">
                ...
                <CardContent className="p-8">
                  ...
                  <p className="text-[#183d64] dark:text-cyan-400 font-medium mb-2 transition-colors">
                    {location.type}
                  </p>
                  <p className="text-gray-600 dark:text-gray-400 transition-colors">{location.address}</p>
                </CardContent>
              </Card>
            </motion.div>
          ))}
