            ...
            >
              <div className="relative bg-gradient-to-br from-gray-50 to-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100">
                ...
                <div className="relative text-center">
                  <div className="w-32 h-32 mx-auto mb-6 rounded-full overflow-hidden border-4 border-white shadow-xl group-hover:scale-105 transition-transform duration-300">
                    <img
                      src={director.image}
                      alt={director.name}
                  ...
                  <p className="text-[#183d64] font-medium mb-6">
                    {director.role}
                  </p>
